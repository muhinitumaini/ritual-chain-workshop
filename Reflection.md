...
**Advantages over commit-reveal:** No reveal phase means answers are never exposed before judging, even to the owner.

**Trade-off:** Requires TEE infrastructure, but offers stronger privacy guarantees.
